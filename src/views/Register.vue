<template>
    <div class="register-contain">
        <div class="register-header bi bi-backspace-fill">
            <RouterLink to="/login">
                <span>注册</span>
            </RouterLink>
        </div>
        <div class="form-group">
            <div class="form-item">
                <label class="bi bi-person-fill"></label>
                <input type="text" placeholder="请输入电子邮箱">
            </div>
            <div class="form-item">
                <label class="bi bi-snapchat"></label>
                <input type="text" placeholder="请输入验证码">
                <button>发送验证码</button>
            </div>
            <div class="form-item">
                <label class="bi bi-key"></label>
                <input type="password" placeholder="请填写密码">
            </div>
            <div class="form-item">
                <label class="bi bi-key-fill"></label>
        ...
        <div class="go-login">
            <RouterLink to="/login">已经有账号？去登录</RouterLink>
        </div>
        <div class="tourism">
            <img src="/img/tourism.png" alt="">
            <img src="/img/tourism2.png" alt="">
            <img src="/img/tourism3.png" alt="">
        </div>
    </div>
</template>
...
登录界面--start*/
.login-bg {
    background-image: url("../image/l-bg.jpg");
